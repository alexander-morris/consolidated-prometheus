...
const index_1 = require("../../task_sdk/typescript/src/index");
...
function main() {
    ...
    const mockNamespaceInstance = new mock_namespace_1.MockNamespace(taskIdFromEnv, "E2ETestTaskRunnerS4");
    ...
    eventHandler.on("status_update", (payload, fullMessage) => {
    ...
    eventHandler.on("task_result", (payload, fullMessage) => {
        ...
        if (payload.status === "completed") {
            ...
            LogLevel.Info, `Custom: Task ${fullMessage.taskId} completed successfully with data: ${JSON.stringify(payload.result_data)}`, "E2ECustomResultComplete");
        }
    });
    // --- End Custom Handlers ---
